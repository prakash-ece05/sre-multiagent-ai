...
class HarnessDeploymentClient:
            ...
            return [
                {
                    ...
                    "status": dep["status"],  # SUCCESS, FAILED, ABORTED, RUNNING
    ...
    def get_all_recent_deployments(self, time_range: str = "24h") -> List[Dict]:
        """
        Get all recent deployments across all services.
        
        Args:
            time_range: Lookback period
